...
public:
	 ...
	 */
	virtual void sendData(CConnection* connection, void* data, int longData, int channel, bool reliable)=0;
  ...
  virtual void sendAll(void* data, size_t longData, int channel, bool reliable)=0;
	 ...
	 * @param receivedPackets Vector de CPaquete* donde se almacenan los paquetes recibidos
	 */
