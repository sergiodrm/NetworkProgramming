...
public:
	 ...
	 */
	virtual void sendData(CConnection* conexion, void* data, int longData, int channel, bool reliable)=0;
  ...
  virtual void sendAll(void* data, size_t longData, int channel, bool reliable)=0;
	 ...
	 */
	virtual void service(std::vector<CPacket*>& paquetesRecibidos)=0;
	 ...
	 */
	virtual void disconnect(CConnection * conexion)=0;
