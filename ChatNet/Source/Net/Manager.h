    ...
    */
	...
	protected:
		...
		*/
		...
		void getPackets(std::vector<Net::CPacket*>& _paquetes);
	...
	private:
		...
		*/
		Net::CFactory* _factoriaRed;

		/**
			 Servidor de red
		*/
		Net::CServer* _servidorRed;

		/**
			Cliente de red
		*/
		Net::CClient* _clienteRed;
		...
		*/
		...
		std::vector<Net::CPacket*> _paquetes;
