...
#include "Cars/Game/CheckPoint.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	CARS_API UClass* Z_Construct_UClass_ACheckPoint();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACheckPoint_OnOverlapBegin_Statics::NewProp_OverlappedActor = { "OverlappedActor", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CheckPoint_eventOnOverlapBegin_Parms, OverlappedActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ACheckPoint_OnOverlapBegin_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACheckPoint_OnOverlapBegin_Statics::NewProp_OverlappedActor,
	...
	IMPLEMENT_CLASS(ACheckPoint, 2252015213);
	template<> CARS_API UClass* StaticClass<ACheckPoint>()
	{
		return ACheckPoint::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACheckPoint(Z_Construct_UClass_ACheckPoint, &ACheckPoint::StaticClass, TEXT("/Script/Cars"), TEXT("ACheckPoint"), false, nullptr, nullptr, nullptr);
