...
void CServerCars::dataPacketReceived(Net::CPacket* packet)
{
...
void CServerCars::connectionPacketReceived(Net::CPacket* packet)
{
  ...
  m_pManager->send(&data, true);
  std::cout << "Client connected! ";
}

//--------------------------------

void CServerCars::disconnectionPacketReceived(Net::CPacket* packet)
{
