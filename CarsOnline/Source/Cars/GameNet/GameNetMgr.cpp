...
void CGameNetMgr::SpawnBomb(unsigned OwnerID, const FVector& InitialPosition)
{
    FActorSpawnParameters spawnParameters;
    spawnParameters.SpawnCollisionHandlingOverride = ESpawnActorCollisionHandlingMethod::AlwaysSpawn;
    spawnParameters.Name = FName("Bomb", OwnerID);
    ABomb* newBomb = m_pCarsGameInstance->GetWorld()->SpawnActor<ABomb>(InitialPosition, FRotator::ZeroRotator,
                                                                        spawnParameters);
    newBomb->OwnerID = OwnerID;

    PlayerBombs[OwnerID] = newBomb;
}
